...
def torPerfAnalysis(s,f,l,u,sources,img,prefix='images/'):
    xD, yD = fetchTorPerf(s,f,l,u,sources)
    draw_graph('TorPerf dataset',l,u,xD,yD,prefix+img)

def DNSAnalysis(s,f,l,u,img,prefix='images/'):
    (xD,yD) = fetchDNSData(s,f,l,u)
    draw_graph('DNS Dataset',l,u,xD,yD,prefix+img)
